...
public class Main {
    ...
    public static void uniqeChallenge() {
        ...
        myString= myString.replaceAll("\"", "");
        myString=  myString.replaceAll("\\+", "");
        myString= myString.replaceAll("\\\\", "siln");
        myString= myString.replaceAll("silnn", "");


        String[] strArr = myString.split(" ");
        Set<String> myArr = new TreeSet<>(Arrays.asList(strArr));
        myArr.remove("");
